...
{   
    ...
    $check = mysqli_query($link,"SELECT * from `admin` WHERE (`Admin ID`='$id' AND `Password`='$password') ");
...
<body>
    ...
    <div class="containerr" style="background-size: 100%;">
        <div class="wrapper">
            ...
            <!-- form content-->
            <form class="form-right" action="Adminlogin.php" method="post" name="myForm" onsubmit="return(validate());">
                <h2 class="text-uppercase" style="color: black;">Login</h2>

                <!-- Class_id course_id-->
                
        
                <div class="mb-3"> <label>Id</label> <input type="text" name="Admin_id" id="Admin" class="input-field"> </div>

                <div class="mb-3"> <label>Id</label> <input type="password" name="password" id="password" class="input-field"> </div>
